...
import { Dog, Cat, Sparkles, Clock, IndianRupee, CheckCircle, Shield, Zap, Crown, Heart, Scissors, PawPrint } from "lucide-react";
    ...
    <Card key={service.id} className="h-full hover:shadow-lg transition-all duration-300 group relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center">
          <h2 className="text-2xl font-bold mb-4">Ready to Book Your Pet's Appointment?</h2>
          <p className="text-muted-foreground mb-6">
            Contact us today to schedule your pet's grooming appointment. We can't wait to make your furry friend look amazing!
          </p>
